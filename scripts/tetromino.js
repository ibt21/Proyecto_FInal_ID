...
class Tetromino {
    ...
    getColorPalette(id) {
        const palette = {
            1: {
                righrTriangle: "#FE8601",
                leftTriangle: "#FFFF",
                square: "#FFDB01"
            },
            2: {
                righrTriangle: "#FE5E02",
                leftTriangle: "#FFFF",
                square: "#FE8602"
            },
            3: {
                righrTriangle: "#B5193B",
                leftTriangle: "#FFFF",
                square: "#ee182E"
            },
            4: {
                righrTriangle: "#22974C",
                leftTriangle: "#FFF",
                square: "#24DC4F"
            },
            5: {
                righrTriangle: "#49BDFF",
                leftTriangle: "#FFF",
                square: "#2D97F7"
            },
            6: {
                righrTriangle: "#0000c9",
                leftTriangle: "#FFF",
                square: "#0101f0"
            },
            7: {
                righrTriangle: "#8500d3",
                leftTriangle: "#FFF",
                square: "#a000f1"
            }
        }
